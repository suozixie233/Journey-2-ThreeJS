...
const environmentMapTexture = cubeTexureLoader.load([
...
// Oppacity and transparent should be used together
...
// material.specular = new THREE.Color(0x11888ff);
...
// material.matelnessMap = doorRoughnessTexture;
